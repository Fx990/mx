...
def umo_in():
    ...
    print(logo)
    shoha()
    print(f' \033[1;91m[\033[1;97m•\033[1;91m]\033[1;92m Example : {xr}+95925,+95258,018,92302,92301,91778{x}')
    shoha()
    rk1 = '+95253'
    rk2 = ',+95796'
    rk3 = '+95440'
    ...
    for bilal in range(passx):
        pww = input(f"\033[1;91m[\033[1;97m•\033[1;91m]\033[1;92m Enter Password {bilal+95} : ")
        HamiiID.append(pww)
